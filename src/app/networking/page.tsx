...
const STAGE_NAV_STYLES = {
  cyan: {
    border: "border-cyan-200/80 hover:border-cyan-400 dark:border-cyan-900/60 dark:hover:border-cyan-500",
    badge: "border border-cyan-200 bg-cyan-50 text-cyan-700 dark:border-cyan-800/80 dark:bg-cyan-950/60 dark:text-cyan-300",
    marker: "bg-cyan-400 shadow-[0_0_12px_rgba(34,211,238,0.5)]",
    arrow: "text-cyan-600 dark:text-cyan-400",
    glow: "hover:shadow-[0_4px_24px_-4px_rgba(8,145,178,0.2)] dark:hover:shadow-[0_4px_24px_-4px_rgba(34,211,238,0.18)]",
  },
  amber: {
    border: "border-amber-200/80 hover:border-amber-400 dark:border-amber-900/60 dark:hover:border-amber-500",
    badge: "border border-amber-200 bg-amber-50 text-amber-700 dark:border-amber-800/80 dark:bg-amber-950/60 dark:text-amber-300",
    marker: "bg-amber-400 shadow-[0_0_12px_rgba(251,191,36,0.5)]",
    arrow: "text-amber-600 dark:text-amber-400",
    glow: "hover:shadow-[0_4px_24px_-4px_rgba(217,119,6,0.2)] dark:hover:shadow-[0_4px_24px_-4px_rgba(251,191,36,0.18)]",
  },
  violet: {
    border: "border-violet-200/80 hover:border-violet-400 dark:border-violet-900/60 dark:hover:border-violet-500",
    badge: "border border-violet-200 bg-violet-50 text-violet-700 dark:border-violet-800/80 dark:bg-violet-950/60 dark:text-violet-300",
    marker: "bg-violet-400 shadow-[0_0_12px_rgba(167,139,250,0.5)]",
    arrow: "text-violet-600 dark:text-violet-400",
    glow: "hover:shadow-[0_4px_24px_-4px_rgba(124,58,237,0.2)] dark:hover:shadow-[0_4px_24px_-4px_rgba(167,139,250,0.18)]",
  },
  lime: {
    border: "border-lime-200/80 hover:border-lime-400 dark:border-lime-900/60 dark:hover:border-lime-500",
    badge: "border border-lime-200 bg-lime-50 text-lime-700 dark:border-lime-800/80 dark:bg-lime-950/60 dark:text-lime-300",
    marker: "bg-lime-400 shadow-[0_0_12px_rgba(163,230,53,0.5)]",
    arrow: "text-lime-600 dark:text-lime-400",
    glow: "hover:shadow-[0_4px_24px_-4px_rgba(101,163,13,0.2)] dark:hover:shadow-[0_4px_24px_-4px_rgba(163,230,53,0.18)]",
  },
} as const;

export default function NetworkingPage() {
  return (
    <div className="min-h-screen overflow-x-hidden bg-[color:var(--surface-l0)] text-[color:var(--text-primary)] transition-colors duration-200">
      <Hero />
            ...
            {STAGES.map((stage) => {
              ...
              return (
                <a
                  key={stage.id}
                  href={`#${stage.id}`}
                  className={`group relative overflow-hidden rounded-xl border bg-[color:var(--surface-l1)] p-4 transition-all duration-200 hover:-translate-y-0.5 focus-visible:ring-2 focus-visible:ring-cyan-400 dark:bg-[color:var(--surface-l1)] ${styles.border} ${styles.glow}`}
                >
                  ...
                  <div className="mt-4 flex items-center justify-between border-t border-[color:var(--border-l1)] pt-3 font-mono text-[10px] uppercase tracking-[0.12em] text-slate-400 dark:text-slate-500">
