...
export default function WirelessSection() {
  ...
  const ssidConfigs: Record<string, SsidConfig> = {
    corp: {
      ...
      color: "text-[#58a6ff]",
      bgBadge: "bg-[#58a6ff]/10 text-[#58a6ff] border-[#58a6ff]/30",
    ...
    guest: {
      ...
      color: "text-[#ffa657]",
      bgBadge: "bg-[#ffa657]/10 text-[#ffa657] border-[#ffa657]/30",
      border: "border-[#ffa657]",
    ...
    iot: {
      ...
      color: "text-[#7ee787]",
      bgBadge: "bg-[#7ee787]/10 text-[#7ee787] border-[#7ee787]/30",
      border: "border-[#7ee787]",
    ...
    voice: {
      ...
      color: "text-[#bc8cff]",
      bgBadge: "bg-[#bc8cff]/10 text-[#bc8cff] border-[#bc8cff]/30",
      border: "border-[#bc8cff]",
  ...
  const calculate24GhzInterference = (ch1: number, ch2: number) => {
    ...
    if (diff === 0) {
      return {
        ...
        badge: "bg-[#ffa657]/20 text-[#ffa657] border-[#ffa657]/40",
      ...
      return {
        ...
        badge: "bg-[#ff7b72]/20 text-[#ff7b72] border-[#ff7b72]/40",
      ...
      return {
        ...
        badge: "bg-[#7ee787]/20 text-[#7ee787] border-[#7ee787]/40",
  ...
  return (
    ...
    >
      ...
      <p className="text-[#8b949e] text-base leading-relaxed mb-8 max-w-4xl">
        Modern Enterprise Wireless LANs (WLANs) seamlessly bridge unguided RF radio signals to wired Ethernet infrastructures. This section explores <strong className="text-[#58a6ff]">SSID-to-VLAN mapping</strong>, <strong className="text-[#7ee787]">Wireless LAN Controller (WLC) topologies</strong>, <strong className="text-[#ffa657]">RF spectrum frequency bands (2.4GHz, 5GHz, 6GHz)</strong>, <strong className="text-[#bc8cff]">Channel Bonding</strong>, and real-time <strong className="text-[#ff7b72]">Signal Propagation & Interference dynamics</strong>.
      </p>
      ...
      <div className="rounded-xl bg-[#0d1117] border border-[#30363d] p-6 mb-10">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 pb-4 border-b border-[#30363d]">
          <div>
            <div className="flex items-center gap-2 mb-1">
              <span className="px-2 py-0.5 rounded bg-[#58a6ff]/20 text-[#58a6ff] font-mono text-xs font-bold">
                Part 1 Architecture
              </span>
              <span className="text-xs font-mono text-[#8b949e]">CAPWAP & 802.1Q Trunking</span>
            </div>
          ...
          <div className="flex items-center bg-[#1c2333] p-1 rounded-lg border border-[#30363d]">
            <button
              ...
              <button
                ...
                className={`p-3 rounded-xl border text-left transition-all flex flex-col justify-between ${
                  selectedSsid === s.id
                    ...
                    : "bg-[#1c2333] border-[#30363d] text-[#8b949e] hover:border-[#58a6ff]/40"
                }`}
              >
                <div>
                  <div className="font-mono text-xs font-bold text-[#e6edf3] mb-1">{s.name}</div>
                  <span className="text-[11px] font-mono opacity-80">VLAN {s.vlanId}</span>
                </div>
                <div className="text-[10px] font-mono mt-2 pt-2 border-t border-[#30363d]/50 flex justify-between">
                  <span>Subnet:</span>
        ...
        <div className="rounded-xl bg-[#1c2333] border border-[#30363d] p-5 mb-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-xs font-mono px-2 py-0.5 rounded bg-[#0d1117] text-[#7ee787] border border-[#30363d]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3 text-center my-4">
            ...
            <div className="p-3 rounded-lg bg-[#0d1117] border border-[#30363d] flex flex-col justify-between">
              <div>
                <span className="text-[10px] font-mono text-[#8b949e] uppercase">Step 1: Client</span>
                <div className="text-xs font-bold text-[#e6edf3] mt-1">Wi-Fi Device</div>
                <div className="text-[11px] text-[#8b949e] mt-1">802.11 Radio Frame</div>
              </div>
              <div className="mt-2 text-[10px] font-mono px-1.5 py-0.5 rounded bg-[#58a6ff]/10 text-[#58a6ff] border border-[#58a6ff]/20">
            ...
            <div className="p-3 rounded-lg bg-[#0d1117] border border-[#30363d] flex flex-col justify-between">
              <div>
                <span className="text-[10px] font-mono text-[#8b949e] uppercase">Step 2: Access Point</span>
                <div className="text-xs font-bold text-[#e6edf3] mt-1">Enterprise AP</div>
                <div className="text-[11px] text-[#8b949e] mt-1">
                  {wlcTopology === "centralized" ? "Encapsulate CAPWAP" : "Inject 802.1Q Tag"}
                </div>
              </div>
              <div className="mt-2 text-[10px] font-mono px-1.5 py-0.5 rounded bg-[#7ee787]/10 text-[#7ee787] border border-[#7ee787]/20">
            ...
            <div className="p-3 rounded-lg bg-[#0d1117] border border-[#30363d] flex flex-col justify-between">
              <div>
                ...
                <div className="text-xs font-bold text-[#e6edf3] mt-1">
              ...
              <div className="mt-2 text-[10px] font-mono px-1.5 py-0.5 rounded bg-[#ffa657]/10 text-[#ffa657] border border-[#ffa657]/20">
            ...
            <div className="p-3 rounded-lg bg-[#0d1117] border border-[#30363d] flex flex-col justify-between">
              <div>
                <span className="text-[10px] font-mono text-[#8b949e] uppercase">Step 4: L3 Gateway</span>
                <div className="text-xs font-bold text-[#e6edf3] mt-1">Core Switch / Router</div>
                <div className="text-[11px] text-[#8b949e] mt-1">Default Gateway SVI</div>
              </div>
              <div className="mt-2 text-[10px] font-mono px-1.5 py-0.5 rounded bg-[#bc8cff]/10 text-[#bc8cff] border border-[#bc8cff]/20">
                {currentSsid.gateway}
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 text-xs font-mono bg-[#0d1117] p-3 rounded-lg border border-[#30363d]">
            <div>
              <span className="text-[#8b949e]">Authentication:</span>
              <div className="text-[#e6edf3] font-semibold mt-0.5">{currentSsid.auth}</div>
            </div>
            <div>
              <span className="text-[#8b949e]">Subnet CIDR:</span>
              <div className="text-[#58a6ff] font-semibold mt-0.5">{currentSsid.subnet}</div>
            </div>
            <div>
              <span className="text-[#8b949e]">QoS & Priority:</span>
              <div className="text-[#7ee787] font-semibold mt-0.5">{currentSsid.priority}</div>
            </div>
            <div>
              <span className="text-[#8b949e]">ACL Policy:</span>
              <div className="text-[#ffa657] font-semibold mt-0.5">{currentSsid.acl}</div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-4 rounded-xl bg-[#1c2333] border border-[#30363d]">
            <div className="flex items-center justify-between mb-2">
              <h4 className="text-sm font-bold text-[#e6edf3]">Centralized WLC (Split MAC Architecture)</h4>
              <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-[#58a6ff]/20 text-[#58a6ff]">CAPWAP Tunnel</span>
            </div>
          ...
          <div className="p-4 rounded-xl bg-[#1c2333] border border-[#30363d]">
            <div className="flex items-center justify-between mb-2">
              <h4 className="text-sm font-bold text-[#e6edf3]">FlexConnect (Local Switching Architecture)</h4>
              <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-[#7ee787]/20 text-[#7ee787]">Branch & Remote APs</span>
            </div>
            <p className="text-xs text-[#8b949e] leading-relaxed">
      ...
      <div className="rounded-xl bg-[#0d1117] border border-[#30363d] p-6 mb-10">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 pb-4 border-b border-[#30363d]">
          <div>
            <div className="flex items-center gap-2 mb-1">
              <span className="px-2 py-0.5 rounded bg-[#7ee787]/20 text-[#7ee787] font-mono text-xs font-bold">
                Part 2 Spectrum Analysis
              </span>
              <span className="text-xs font-mono text-[#8b949e]">2.4 GHz vs 5 GHz vs 6 GHz (Wi-Fi 6E/7)</span>
            </div>
            <h3 className="text-xl font-bold text-[#e6edf3]">
        ...
        <div className="rounded-xl bg-[#1c2333] border border-[#30363d] p-5 mb-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4 pb-3 border-b border-[#30363d]">
            <h4 className="text-lg font-bold text-[#e6edf3]">{currentBand.name}</h4>
            <span className="text-xs font-mono text-[#58a6ff] bg-[#0d1117] px-3 py-1 rounded-md border border-[#30363d]">
              {currentBand.spectrum}
            </span>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            <div className="bg-[#0d1117] p-3 rounded-lg border border-[#30363d] text-xs space-y-1 font-mono">
              <div className="text-[#8b949e]">Max Channel Width:</div>
              <div className="text-[#7ee787] font-bold">{currentBand.maxWidth}</div>
              <div className="text-[#8b949e] pt-2">Max PHY Speed:</div>
              <div className="text-[#58a6ff] font-bold">{currentBand.maxPhy}</div>
            </div>

            <div className="bg-[#0d1117] p-3 rounded-lg border border-[#30363d] text-xs space-y-1 font-mono">
              <div className="text-[#8b949e]">Range & Wall Penetration:</div>
              <div className="text-[#ffa657] font-bold">{currentBand.penetration}</div>
              <div className="text-[#8b949e] pt-2">Interference Risk:</div>
              <div className="text-[#ff7b72] font-bold">{currentBand.interference}</div>
            </div>

            <div className="bg-[#0d1117] p-3 rounded-lg border border-[#30363d] text-xs space-y-1 font-mono">
              <div className="text-[#8b949e]">Non-Overlapping Channels:</div>
              <div className="text-[#bc8cff] font-bold">{currentBand.channels}</div>
              <div className="text-[#8b949e] pt-2">Key Technologies:</div>
              <div className="text-[#e6edf3] font-semibold">{currentBand.keyTech}</div>
            </div>
          </div>

          {/* Pros & Cons */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-[#0d1117]/80 p-3 rounded-lg border border-[#7ee787]/30 text-xs">
              <div className="font-bold text-[#7ee787] mb-2 flex items-center gap-1.5">
                <span className="w-2 h-2 rounded-full bg-[#7ee787]"></span> Advantages
              </div>
            ...
            <div className="bg-[#0d1117]/80 p-3 rounded-lg border border-[#ff7b72]/30 text-xs">
              <div className="font-bold text-[#ff7b72] mb-2 flex items-center gap-1.5">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs font-mono border-collapse">
            <thead>
              <tr className="border-b border-[#30363d] bg-[#1c2333] text-[#e6edf3]">
                <th className="p-3">Specification / Metric</th>
                <th className="p-3 text-[#ffa657]">2.4 GHz Band</th>
                <th className="p-3 text-[#58a6ff]">5 GHz Band</th>
                <th className="p-3 text-[#bc8cff]">6 GHz Band (Wi-Fi 6E/7)</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-[#30363d] text-[#8b949e]">
              <tr>
                <td className="p-3 font-bold text-[#e6edf3]">Frequency Range</td>
              ...
              <tr className="bg-[#161b22]/50">
                <td className="p-3 font-bold text-[#e6edf3]">Total Spectrum Pool</td>
                <td className="p-3 text-[#ffa657]">~83.5 MHz</td>
                <td className="p-3 text-[#58a6ff]">~500 MHz</td>
                <td className="p-3 text-[#bc8cff] font-bold">~1,200 MHz (Massive)</td>
              </tr>
              <tr>
                <td className="p-3 font-bold text-[#e6edf3]">20MHz Non-Overlapping Ch.</td>
                <td className="p-3">3 Channels (1, 6, 11)</td>
                <td className="p-3">Up to 25 Channels</td>
                <td className="p-3 font-bold text-[#7ee787]">Up to 59 Channels</td>
              </tr>
              <tr className="bg-[#161b22]/50">
                <td className="p-3 font-bold text-[#e6edf3]">Max Supported Channel Width</td>
                <td className="p-3">20 MHz (40MHz unsafe)</td>
                <td className="p-3">20 / 40 / 80 / 160 MHz</td>
                <td className="p-3 font-bold text-[#bc8cff]">Up to 320 MHz (Wi-Fi 7)</td>
              </tr>
              <tr>
                <td className="p-3 font-bold text-[#e6edf3]">Indoor Coverage Distance</td>
                <td className="p-3 text-[#7ee787]">~35m (High penetration)</td>
                <td className="p-3 text-[#58a6ff]">~25m (Moderate penetration)</td>
                <td className="p-3 text-[#ff7b72]">~15m (Line-of-sight preferred)</td>
              </tr>
              <tr className="bg-[#161b22]/50">
                <td className="p-3 font-bold text-[#e6edf3]">Interference Sources</td>
                <td className="p-3 text-[#ff7b72]">Microwaves, Bluetooth, Zigbee</td>
                <td className="p-3 text-[#ffa657]">DFS Weather Radars</td>
                <td className="p-3 text-[#7ee787] font-bold">Zero Legacy Devices (Clean)</td>
              </tr>
              <tr>
                <td className="p-3 font-bold text-[#e6edf3]">Max Theoretical PHY Speed</td>
                <td className="p-3">1.1 Gbps (Wi-Fi 6)</td>
                <td className="p-3">9.6 Gbps (Wi-Fi 6)</td>
                <td className="p-3 text-[#bc8cff] font-bold">46.1 Gbps (Wi-Fi 7 MLO)</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div className="rounded-xl bg-[#0d1117] border border-[#30363d] p-6 mb-10">
        <div className="flex items-center gap-2 mb-1">
          <span className="px-2 py-0.5 rounded bg-[#ffa657]/20 text-[#ffa657] font-mono text-xs font-bold">
            Part 3 Channel Planning
          </span>
          <span className="text-xs font-mono text-[#8b949e]">Channels 1, 6, 11 & Bonding Tree</span>
        </div>
        ...
        <div className="rounded-xl bg-[#1c2333] border border-[#30363d] p-5 mb-8">
          <h4 className="text-sm font-bold text-[#e6edf3] mb-3 flex items-center justify-between">
            ...
            <span className="text-xs font-mono text-[#8b949e]">20 MHz Width / 5 MHz Spacing</span>
          </h4>

          {/* Controls for AP 1 and AP 2 Channel */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-5">
            <div className="bg-[#0d1117] p-3 rounded-lg border border-[#30363d]">
              <label className="block text-xs font-mono text-[#58a6ff] mb-1">
                Access Point 1 Channel: <span className="text-[#e6edf3] font-bold">{ap1Channel}</span>
              </label>
              <input
                type="range"
                min="1"
              ...
              />
              <div className="flex justify-between text-[10px] font-mono text-[#8b949e] mt-1">
            ...
            <div className="bg-[#0d1117] p-3 rounded-lg border border-[#30363d]">
              <label className="block text-xs font-mono text-[#ffa657] mb-1">
                Access Point 2 Channel: <span className="text-[#e6edf3] font-bold">{ap2Channel}</span>
              </label>
              <input
                type="range"
                min="1"
          ...
          <div className="bg-[#0d1117] p-4 rounded-lg border border-[#30363d] mb-4">
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs font-mono text-[#8b949e]">Calculated Interaction:</span>
            ...
            <p className="text-xs text-[#8b949e] leading-relaxed">{chInterference.desc}</p>
          </div>

          {/* Visual Channel Spectral Bar */}
          <div className="relative pt-6 pb-2">
            <div className="flex justify-between text-[10px] font-mono text-[#8b949e] mb-1 px-1">
            ...
            {/* Spectrum Range Bar */}
            <div className="h-6 w-full bg-[#0d1117] rounded-lg border border-[#30363d] relative overflow-hidden flex items-center px-1">
              {/* Highlight non-overlapping 1, 6, 11 zones */}
              <div className="absolute left-[0%] width-[20%] h-full bg-[#7ee787]/10 border-r border-[#7ee787]/30"></div>
              <div className="absolute left-[45%] width-[20%] h-full bg-[#7ee787]/10 border-x border-[#7ee787]/30"></div>
              <div className="absolute left-[80%] width-[20%] h-full bg-[#7ee787]/10 border-l border-[#7ee787]/30"></div>

              {/* AP 1 Marker */}
              <div
                className="absolute h-4 w-12 rounded bg-[#58a6ff]/80 text-[#0d1117] text-[10px] font-mono font-bold flex items-center justify-center transition-all shadow"
              ...
              {/* AP 2 Marker */}
              <div
                className="absolute h-4 w-12 rounded bg-[#ffa657]/80 text-[#0d1117] text-[10px] font-mono font-bold flex items-center justify-center transition-all shadow"
        ...
        <div className="rounded-xl bg-[#1c2333] border border-[#30363d] p-5">
          ...
          <div className="space-y-3 font-mono text-xs">
            ...
            <div>
              <div className="text-[10px] text-[#8b949e] mb-1">Base 20 MHz Channels:</div>
            ...
            {(bondingWidth >= 40) && (
              <div>
                <div className="text-[10px] text-[#8b949e] mb-1">Bonded 40 MHz Channels:</div>
                <div className="grid grid-cols-4 gap-1 text-center">
                  <div className="p-1.5 rounded bg-[#58a6ff]/10 border border-[#58a6ff]/30 text-[#58a6ff] font-bold">
                    Ch 38 (36+40)
                  </div>
                  <div className="p-1.5 rounded bg-[#58a6ff]/10 border border-[#58a6ff]/30 text-[#58a6ff] font-bold">
                    Ch 46 (44+48)
            ...
            {(bondingWidth >= 80) && (
              <div>
                <div className="text-[10px] text-[#8b949e] mb-1">Bonded 80 MHz Channels:</div>
                <div className="grid grid-cols-2 gap-1 text-center">
                  <div className="p-2 rounded bg-[#7ee787]/10 border border-[#7ee787]/30 text-[#7ee787] font-bold">
                    Ch 42 (36+40+44+48)
                  </div>
                  <div className="p-2 rounded bg-[#7ee787]/10 border border-[#7ee787]/30 text-[#7ee787] font-bold">
            ...
            {(bondingWidth >= 160) && (
              <div>
                <div className="text-[10px] text-[#8b949e] mb-1">Bonded 160 MHz Channel:</div>
                <div className="p-2.5 rounded bg-[#bc8cff]/10 border border-[#bc8cff]/40 text-[#bc8cff] font-bold text-center">
            ...
            {/* 320 MHz Bonded Note */}
            {(bondingWidth === 320) && (
              <div className="p-3 rounded-lg bg-[#bc8cff]/20 border border-[#bc8cff]/50 text-xs text-[#e6edf3]">
                <div className="font-bold text-[#bc8cff] mb-1">Wi-Fi 7 (802.11be) 320 MHz Channel (6 GHz Only)</div>
          ...
          <div className="mt-4 p-3 rounded-lg bg-[#0d1117] border border-[#30363d] text-xs flex items-center justify-between">
            <div className="text-[#8b949e]">
              <strong className="text-[#ff7b72]">Thermal Noise Penalty:</strong> Doubling channel width doubles noise floor (+3 dB noise).
            </div>
            <div className="font-mono text-[#ffa657] font-bold">
      ...
      <div className="rounded-xl bg-[#0d1117] border border-[#30363d] p-6">
        <div className="flex items-center gap-2 mb-1">
          <span className="px-2 py-0.5 rounded bg-[#ff7b72]/20 text-[#ff7b72] font-mono text-xs font-bold">
            Part 4 Simulator
          </span>
          <span className="text-xs font-mono text-[#8b949e]">RSSI, Noise Floor, SNR & Spectrum Mask</span>
        </div>
        <h3 className="text-xl font-bold text-[#e6edf3] mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="space-y-4 bg-[#1c2333] p-4 rounded-xl border border-[#30363d]">
            <h4 className="text-xs font-mono font-bold text-[#58a6ff] uppercase">1. Transmitter & Environment</h4>

            {/* Band Select */}
            <div>
              <label className="block text-xs font-mono text-[#8b949e] mb-1">Frequency Band:</label>
                ...
                {(["2.4", "5", "6"] as const).map((b) => (
                  <button
                    ...
                    className={`py-1 rounded text-xs font-mono font-semibold transition-all ${
                      simBand === b ? "bg-[#58a6ff] text-[#0d1117]" : "bg-[#0d1117] text-[#8b949e]"
                    }`}
                  >
                    {b} GHz
                  </button>
            ...
            <div>
              <div className="flex justify-between text-xs font-mono text-[#8b949e] mb-1">
                <span>TX Power:</span>
                <span className="text-[#e6edf3] font-bold">{txPower} dBm ({Math.round(Math.pow(10, txPower / 10))} mW)</span>
              </div>
              <input
                type="range"
                min="5"
            ...
            <div>
              <div className="flex justify-between text-xs font-mono text-[#8b949e] mb-1">
                <span>Distance:</span>
                <span className="text-[#e6edf3] font-bold">{distance} meters</span>
              </div>
              <input
                type="range"
                min="1"
            ...
            {/* Obstacle Select */}
            <div>
              <label className="block text-xs font-mono text-[#8b949e] mb-1">Obstacles / Walls:</label>
              <select
                value={obstacleLoss}
                onChange={(e) => setObstacleLoss(parseInt(e.target.value))}
                className="w-full bg-[#0d1117] border border-[#30363d] rounded p-2 text-xs font-mono text-[#e6edf3]"
              >
          ...
          <div className="space-y-4 bg-[#1c2333] p-4 rounded-xl border border-[#30363d]">
            <h4 className="text-xs font-mono font-bold text-[#ffa657] uppercase">2. AP Channels & Noise</h4>

            {/* Noise Floor Preset */}
            <div>
              <label className="block text-xs font-mono text-[#8b949e] mb-1">RF Noise Floor Preset:</label>
              <select
                value={noiseFloor}
            ...
            <div>
              <label className="block text-xs font-mono text-[#58a6ff] mb-1">AP 1 Primary Channel:</label>
              <select
                value={simAp1Ch}
            ...
            <div>
              <label className="block text-xs font-mono text-[#ffa657] mb-1">AP 2 Co-Located Channel:</label>
              <select
                value={simAp2Ch}
          ...
          <div className="space-y-3 bg-[#1c2333] p-4 rounded-xl border border-[#30363d] flex flex-col justify-between font-mono text-xs">
            <div>
              <h4 className="text-xs font-mono font-bold text-[#7ee787] uppercase mb-3">3. Derived Signal Quality</h4>

              <div className="space-y-2">
                <div className="flex justify-between p-2 rounded bg-[#0d1117] border border-[#30363d]">
                  <span className="text-[#8b949e]">Path Loss (FSPL):</span>
                  <span className="text-[#ff7b72] font-bold">-{pathLoss} dB</span>
                </div>

                <div className="flex justify-between p-2 rounded bg-[#0d1117] border border-[#30363d]">
                  <span className="text-[#8b949e]">RSSI (Signal):</span>
                  <span className={`font-bold ${rssi > -65 ? "text-[#7ee787]" : rssi > -78 ? "text-[#ffa657]" : "text-[#ff7b72]"}`}>
                    {rssi} dBm
                  </span>
                </div>

                <div className="flex justify-between p-2 rounded bg-[#0d1117] border border-[#30363d]">
                  <span className="text-[#8b949e]">Signal-to-Noise (SNR):</span>
                  <span className={`font-bold ${snr >= 25 ? "text-[#7ee787]" : snr >= 15 ? "text-[#58a6ff]" : "text-[#ff7b72]"}`}>
                    {snr} dB
                  </span>
                </div>

                <div className="flex justify-between p-2 rounded bg-[#0d1117] border border-[#30363d]">
                  <span className="text-[#8b949e]">Est. MCS Index:</span>
                  <span className="text-[#e6edf3] font-bold">{mcsIndex} ({qamModulation})</span>
                </div>

                <div className="flex justify-between p-2 rounded bg-[#0d1117] border border-[#30363d]">
                  <span className="text-[#8b949e]">Max PHY Throughput:</span>
                  <span className="text-[#7ee787] font-bold">{phySpeed} Mbps</span>
                </div>
              </div>
            </div>

            <div className={`p-2.5 rounded-lg border text-center text-xs font-bold ${linkColor} bg-[#0d1117]`}>
              {linkQuality}
            </div>
          </div>
        </div>
        ...
        <div className="rounded-xl bg-[#1c2333] border border-[#30363d] p-5">
          ...
          {/* SVG Spectrum Graph */}
          <div className="w-full h-48 bg-[#0d1117] rounded-lg border border-[#30363d] p-4 relative flex flex-col justify-between">
