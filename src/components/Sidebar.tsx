...
export const MODULE_ITEMS_BY_TRACK: Record<string, NavItem[]> = {
  ...
  networking: [
    ...
    { id: "create",          num: "05", label: "Local Creation",      category: "Foundations", icon: "⊞" },
    { id: "vlsm",            num: "06", label: "VLSM Design",         category: "Foundations", icon: "◐" },
    { id: "supernetting",    num: "07", label: "Supernetting",        category: "Foundations", icon: "⬡" },
    { id: "vlans",           num: "08", label: "VLANs & Subnets",     category: "Applied",     icon: "⬡" },
    { id: "dhcp",            num: "09", label: "DHCP & IPAM",         category: "Applied",     icon: "⬡" },
    { id: "ipv6",            num: "10", label: "IPv6 Next-Gen",       category: "Applied",     icon: "⑂" },
    { id: "ips",             num: "11", label: "NAT & IP Types",      category: "Applied",     icon: "⊕" },
    { id: "cloud",           num: "12", label: "Cloud VPCs",          category: "Applied",     icon: "◉" },
    { id: "wireless",        num: "13", label: "Wireless WLAN",       category: "Applied",     icon: "⬡" },
    { id: "packets",         num: "14", label: "Packets & Wireshark", category: "Operations",  icon: "◈" },
    { id: "routing",         num: "15", label: "Routing & Gateways",  category: "Operations",  icon: "⑂" },
    { id: "firewall",        num: "16", label: "Firewall ACLs",       category: "Operations",  icon: "◐" },
    { id: "security",        num: "17", label: "Security Control",    category: "Operations",  icon: "◉" },
